...
class TradingGraph:
    ...
    def _get_api_key(self, provider: str = "openai") -> str:
        ...
        if provider == "openai":
            ...
            if api_key == "":
                raise ValueError(
                    "Please provide your actual Google API key. "
                    "You can get one from: https://console.cloud.google.com/apis/credentials"
                )
        else:
            raise ValueError(
                f"Unsupported provider: {provider}. Must be 'openai', 'anthropic', 'qwen', or 'google'"
            )
    ...
    def _create_llm(
        ...
        Args:
            provider: The provider name ("openai", "anthropic", "qwen", or "google")
    ...
    def update_api_key(self, api_key: str, provider: str = "openai"):
        ...
        Args:
            ...
            provider (str): The provider name ("openai", "anthropic", "qwen", or "google"), defaults to "openai"
        """
        if provider == "openai":
