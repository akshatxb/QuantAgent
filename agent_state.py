...
class IndicatorAgentState(TypedDict):
    ...
    indicator_direction: Annotated[
        str, "Structured direction from indicator agent: BULLISH / BEARISH / NEUTRAL"
    ]
    indicator_confidence: Annotated[
        str, "Structured confidence from indicator agent: HIGH / MEDIUM / LOW"
    ]
    ...
    pattern_direction: Annotated[
        str, "Structured direction from pattern agent: BULLISH / BEARISH / NEUTRAL"
    ]
    pattern_confidence: Annotated[
        str, "Structured confidence from pattern agent: HIGH / MEDIUM / LOW"
    ]
    ...
    trend_direction: Annotated[
        str, "Structured direction from trend agent: BULLISH / BEARISH / NEUTRAL"
    ]
    trend_confidence: Annotated[
        str, "Structured confidence from trend agent: HIGH / MEDIUM / LOW"
    ]
    ...
    unanimous_signal: Annotated[
        bool,
        "True if all 3 analyst agents (indicator, pattern, trend) agreed on direction"
    ]
